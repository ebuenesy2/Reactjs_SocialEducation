               ...
               <div className="widgetCardDataTimeLineBottom" >
                  ...
                  {Array(props.JsonData.length).fill(0).map((el, i) => 
                     ...
                     <div className="widgetCardDataTimeLineBottomInfoBox">
                         ...
                         <div className="widgetCardDataTimeLineBottomInfoBoxDescription" style={{ color: props.colorBoxDescription ? props.colorBoxDescription : "black", fontSize: props.fontSizeBoxDescription ? props.fontSizeBoxDescription : "16px", fontWeight:props.fontWeightBoxDescription ? props.fontWeightBoxDescription : "700"  }} > {props.JsonData[i].content} </div>
                     </div>                   
